<template>
	<view class="searchLayout">
		...
		<view class="noSearch" v-if="noSearch">
			<uv-empty mode="search" icon="https://img2.baidu.com/it/u=3618407860,3254998994&fm=253&fmt=auto&app=138&f=PNG?w=500&h=500"></uv-empty>
		</view>
...
const searchData = async ()=>{
	try{
		...
		if(res.data.data.length == 0 && classList.value.length==0) noSearch.value = true;
		console.log(res);
	}finally{
		uni.hideLoading()
	}
